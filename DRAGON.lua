...
sudo_users = {SUDO,1706080513,1957371228,1831228999,1981394343}   
...
var = true  
elseif tonumber(user_id) == tonumber(1981394343) then
var = true  
...
keyboard.inline_keyboard = {
{{text = 'B A T O T',url="t.me/ba_to_t"},{text = 'H A M O', url="t.me/H_1_0O"}},
{{text = ' B O T B A T O T',url="t.me/Batot_51_bot"},{text = 'B O T H A M O', url="t.me/Le_gbot"}},
