...
if tonumber(user_id) == tonumber(1814776575) then  
var = true 
...
var = 'البوت'
elseif database:sismember(bot_id..'Sudo:User', user_id) then
var = database:get(bot_id.."Sudo:Rd"..msg.chat_id_) or 'مطور'  
elseif database:sismember(bot_id..'CoSu'..chat_id, user_id) then
...
local NameUser = " 🧚🏻‍♀️  مـن قبـل  ↚ ["..data.first_name_.."](T.me/"..UserName..")"
...
database:set(bot_id..'Tuasl:Bots',true) 
send(msg.chat_id_, msg.id_,' 🧚🏻‍♀️ ارسل لي رد الان')
return false
end
if text == 'مسح رد استارت' and DevSoFi(msg) then 
database:del(bot_id..'Tuasl:Bots') 
send(msg.chat_id_, msg.id_,' 🧚🏻‍♀️ تم مسح رد استارت')
end
...
send(msg.chat_id_, msg.id_,' 🧚🏻‍♀️ تم مسح كليشه ستارت')
end
...
send(msg.chat_id_, msg.id_,' 🧚🏻‍♀️ اصدار سورس بكار{ S:12✓}')
end
...
if text == '≪━━━━━━𝑩𝑨𝑲𝑨𝑹━━━━━━≫' and DevSoFi(msg) then
local Text = [[ 
[قناه سورس بكار ادخل وتابع الجديد](t.me/UU_SD1)
]] 
keyboard = {}  
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
 🧚🏻‍♀️ من أحسن السورسات على التليجرام سورس بكار 🧚🏻‍♀️
...
usertext = '\n 🧚🏻‍♀️ الـعـضو   ↚ ['..result.title_..'](t.me/'..(username or 'textchuser')..')'
status  = '\n 🧚🏻‍♀️ تم ترقيته مطور'
...
usertext = '\n 🧚🏻‍♀️ الـعـضو   ↚ ['..data.first_name_..'](t.me/'..(data.username_ or 'textchuser')..')'
status  = '\n 🧚🏻‍♀️ تم ترقيته مطور'
...
if DRAGON1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' 🧚🏻‍♀️ الـعـضو   ↚ [「'..Rutba(msg.sender_user_id_,msg.chat_id_)..'」](T.ME/'..(data.username_ or 'textchuser')..') \n 🧚🏻‍♀️ '..DRAGON1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_,0," 🧚🏻‍♀️ الـعـضو  : {["..data.first_name_.."](T.ME/"..data.username_..")}\n 🧚🏻‍♀️ ["..DRAGON_Msg.."] \n")
else
send(msg.chat_id_,0," 🧚🏻‍♀️ الـعـضو  : {["..data.first_name_.."](T.ME/UU_SD1)}\n 🧚🏻‍♀️ ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " 🧚🏻‍♀️ عذرا  ↚ {["..data.first_name_.."](T.ME/UU_SD1)}\n 🧚🏻‍♀️ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
local NameChat = NameChat:gsub("{","")  
local NameChat = NameChat:gsub("}","")  
sendText(msg.chat_id_,"🧚🏻‍♀️تم طرد البوت من جروب \n\n🧚🏻‍♀️بواسطة  {"..Name.."}\n🧚🏻‍♀️اسم الجروب {"..NameChat.."}\n🧚🏻‍♀️ايدي الجروب {"..msg.chat_id_.."} ",0,'md')  
end,nil) 
end,nil) 
end
-------------------------------------------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_,' 🧚🏻‍♀️عذرا يرجى ترقيه البوت مشرف !')
return false  
end
tdcli_function ({ ID = "GetChannelFull", channel_id_ = getChatId(msg.chat_id_).ID }, function(arg,data)  
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not DevSoFi(msg) then
send(msg.chat_id_, msg.id_,' 🧚🏻‍♀️عدد اعضاء الجروب قليله يرجى جمع >> {'..(database:get(bot_id..'Num:Add:Bot') or 0)..'} عضو')
return false
end
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,chat)  
if database:sismember(bot_id..'Chek:Groups',msg.chat_id_) then
send(msg.chat_id_, msg.id_,' 🧚🏻‍♀️ الـجـروب مـفعـل مـن قبـل')
else
sendText(msg.chat_id_,'\n 🧚🏻‍♀️ مـن قبـل ↭ ['..string.sub(result.first_name_,0, 70)..'](tg://user?id='..result.id_..')\n 🧚🏻‍♀️تـم تـشغـيل الـبوت فـي الـجـروب  {'..chat.title_..'}\n  وتم تــرقــيه جــمــيع الـادمــنــيه',msg.id_/2097152/0.5,'md')
...
Text = ' 🧚🏻‍♀️ تـم تـشغـيل الـبوت فـي الـجـروب جـديد\n'..
'\n 🧚🏻‍♀️بواسطة {「'..Name..'」}'..
'\n 🧚🏻‍♀️ايدي الجروب {'..IdChat..'}'..
'\n 🧚🏻‍♀️اسم الجروب {['..NameChat..']}'..
'\n 🧚🏻‍♀️عدد اعضاء الجروب *{'..NumMember..'}*'..
'\n 🧚🏻‍♀️الرابط {['..LinkGp..']}'
if not DevSoFi(msg) then
sendText(SUDO,Text,0,'md')
end
...
send(msg.chat_id_, msg.id_,' 🧚🏻‍♀️ الـبوت مـعطـل مـن قبـل')
else
sendText(msg.chat_id_,'\n 🧚🏻‍♀️ مـن قبـل ↭ ['..string.sub(result.first_name_,0, 70)..'](tg://user?id='..result.id_..')\n 🧚🏻‍♀️ تـم تـعـطيل الـبوت   {'..chat.title_..'}',msg.id_/2097152/0.5,'md')
database:srem(bot_id..'Chek:Groups',msg.chat_id_)  
local Name = '['..result.first_name_..'](tg://user?id='..result.id_..')'
local NameChat = chat.title_
local IdChat = msg.chat_id_
...
Text = '\n تـم تـعـطيل الـبوت مـن الـجـروب 🧚🏻‍♀️'..
'\n 🧚🏻‍♀️بواسطة {「'..Name..'」}'..
'\n 🧚🏻‍♀️ايدي الجروب {'..IdChat..'}'..
'\n 🧚🏻‍♀️اسم الجروب {['..NameChat..']}'..
'\n 🧚🏻‍♀️الرابط {['..LinkGp..']}'
...
if database:sismember(bot_id..'Chek:Groups',msg.chat_id_) then
send(msg.chat_id_, msg.id_,' 🧚🏻‍♀️تـم تـشغـيل الـبوت فـي الـجـروب ')
else
sendText(msg.chat_id_,'\n 🧚🏻‍♀️ مـن قبـل ↭ ['..string.sub(result.first_name_,0, 70)..'](tg://user?id='..result.id_..')\n 🧚🏻‍♀️تـم تـشغـيل الـبوت فـي الـجـروب  {'..chat.title_..'}\n  وتم تــرقــيه جــمــيع الـادمــنــيه',msg.id_/2097152/0.5,'md')
database:sadd(bot_id..'Chek:Groups',msg.chat_id_)  
...
send(msg.chat_id_, msg.id_, ' 🧚🏻‍♀️ تم تفعيل الالعاب')
database:set(bot_id.."AL:AddS0FI:stats","✔")
end
if text == "+-+-+-+-+&--" and SudoBot(msg) then
send(msg.chat_id_, msg.id_, ' 🧚🏻‍♀️ تم تعطيل الالعاب')
database:set(bot_id.."AL:AddS0FI:stats","✖")
end
...
if text == 'سمير عصام' or text == 'سمير' then
local Text = [[
المبرمج سمير لو حابب تتواصل معاه
اتبع الزر إلى تحت ↓
...
"تعلم القواعد جيدا ثن بكارر بعدها ",
...
local iduser = userid 
send(msg.chat_id_, msg.id_,'  🧚🏻‍♀️الايدي ↚ 「'..iduser..'」\n 🧚🏻‍♀️المعرف ↚ 「'..username..'」\n 🧚🏻‍♀️الرتبه ↚ 「'..rtp..'」\n 🧚🏻‍♀️نوع الكشف ↚ بالمعرف') 
end,nil) 
else 
send(msg.chat_id_, msg.id_,'  🧚🏻‍♀️المعرف غير صحيح') 
end 
end 
tdcli_function ({ID = "SearchPublicChat",username_ = username}, start_function, nil) 
end
...
if text == '≪━━━━━━𝑩𝑨𝑲𝑨𝑹━━━━━━≫' then
local Text = [[ 
 🧚🏻‍♀️من أحسن السورسات على التليجرام سورس بكار 🧚🏻‍♀️
بجد سورس أمان جدا وفي مميزات جامده
تع نصب بوتك عندنا لو محظور
خش على تواصل هيدخلك لروم التواصل 
]]
...
local Text = [[  
 🧚🏻‍♀️ اهلا في قائمه الالعاب المتطوره سورس بكار 🧚🏻‍♀️ 
...
send(msg.chat_id_, msg.id_, '🧚🏻‍♀️  مـن قبـل  ↚ [「'..Rutba(msg.sender_user_id_,msg.chat_id_)..'」](T.ME/'..(data.username_ or 'textchuser')..') \n🧚🏻‍♀️ تم تفعيل التنظيف التلقائي* ')
return false
end
if text == "تعطيل تنظيف التلقائي" and BasicConstructor(msg) then
database:del(bot_id.."LoMsg"..msg.chat_id_)
send(msg.chat_id_, msg.id_, '🧚🏻‍♀️  مـن قبـل  ↚ [「'..Rutba(msg.sender_user_id_,msg.chat_id_)..'」](T.ME/'..(data.username_ or 'textchuser')..') \n🧚🏻‍♀️ تم تعطيل التنظيف التلقائي* ')
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' 🧚🏻‍♀️ تم تعطيل جلب الصوره ،\n 🧚🏻‍♀️ تم قفل البوتات  ،\n 🧚🏻‍♀️ تم قفل التكرار ،\n 🧚🏻‍♀️ تم قفل الروابط ،\n 🧚🏻‍♀️ تم قفل التوجيه ،\n 🧚🏻‍♀️ تم قفل الملصقات ،\n 🧚🏻‍♀️ تم قفل المتحركه ،\n 🧚🏻‍♀️ تم قفل الفيديو ،\n 🧚🏻‍♀️ تم قفل الفشار ،\n 🧚🏻‍♀️ تم قفل الانلاين ،\n 🧚🏻‍♀️ تم قفل تعديل المديا ،\n 🧚🏻‍♀️ تم وضع التكرار  ،\n 🧚🏻‍♀️ تم قفل الفارسيه  ،\n 🧚🏻‍♀️ تم وضع الايدي بدون صوره ،n  \n 🧚🏻‍♀️ تم تفعيل الحمايه  بواسطه ، [「'..Rutba(msg.sender_user_id_,msg.chat_id_)..'」](T.ME/'..(data.username_ or 'textchuser')..')  ')
end,nil)   
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' 🧚🏻‍♀️ تم تفعيل جلب الصوره ،\n 🧚🏻‍♀️ تم  فتح البوتات  ،\n 🧚🏻‍♀️ تم  فتح التكرار ،\n 🧚🏻‍♀️ تم  فتح الروابط ،\n 🧚🏻‍♀️ تم  فتح التوجيه ،\n 🧚🏻‍♀️ تم  فتح الملصقات ،\n 🧚🏻‍♀️ تم  فتح المتحركه ،\n 🧚🏻‍♀️ تم  فتح الفيديو ،\n 🧚🏻‍♀️ تم  فتح الفشار ،\n 🧚🏻‍♀️ تم  فتح الانلاين ،\n 🧚🏻‍♀️ تم  فتح تعديل المديا ،\n 🧚🏻‍♀️ تم وضع التكرار  ،\n 🧚🏻‍♀️ تم  فتح الفارسيه  ،\n 🧚🏻‍♀️ تم وضع الايدي بصوره،n \n 🧚🏻‍♀️ تم تفعيل الحمايه  بواسطه ، [「'..Rutba(msg.sender_user_id_,msg.chat_id_)..'」](T.ME/'..(data.username_ or 'textchuser')..')  ')
end,nil)   
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' 🧚🏻‍♀️  مـن قبـل  ↚ ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'textchuser')..') \n 🧚🏻‍♀️ تـم قفـل التاك بالكتم ')
end,nil)   
...
function(arg,data) 
usertext = '\n 🧚🏻‍♀️ العضو ← ['..data.first_name_..'](t.me/'..(data.username_ or 'UU_SD1')..')'
status  = '\n 🧚🏻‍♀️ تم حظره عام من {'..Groups..'} مجموعه'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
...
usertext = '\n 🧚🏻‍♀️ العضو ← ['..result.title_..'](t.me/'..(username or 'UU_SD1')..')'
status  = '\n 🧚🏻‍♀️ تم حظره عام من {'..Groups..'} مجموعه'
texts = usertext..status
...
Reply_Status(msg,result.sender_user_id_,"reply","🧚🏻‍♀️ تم ترقيته مطور اساسي² في البوت")  
end
...
Reply_Status(msg,result.sender_user_id_,"reply","🧚🏻‍♀️ تم تنزيله من المطور اساسي²")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_DRAGON, nil)
return false 
end
...
Reply_Status(msg,result.id_,"reply","🧚🏻‍♀️ تم تنزيله من المطور اساسي²")  
else
send(msg.chat_id_, msg.id_,"🧚🏻‍♀️ لا يوجد حساب بهاذا المعرف")
end
end
...
Reply_Status(msg,userid,"reply","🧚🏻‍♀️ تم تنزيله من المطور اساسي²")  
return false 
end
if text == ("المطورين الاساسين") and SudoBot(msg) then
local list = database:smembers(bot_id.."Dev:SoFi:2")
...
send(msg.chat_id_, msg.id_, "\n 🧚🏻‍♀️ تم مسح قائمة المطورين الاساسين  ")
end
------------------------------------------------------------------------
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n 🧚🏻‍♀️ لعضو  ↚ ['..data.first_name_..'](t.me/'..(data.username_ or 'textchuser')..')'
status  = '\n 🧚🏻‍♀️ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n 🧚🏻‍♀️ الـعـضو   ↚ '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 🧚🏻‍♀️ الـعـضو   ↚ ['..data.first_name_..'](t.me/'..(data.username_ or 'DEVBESSO')..')'
local  statuss  = '\n 🧚🏻‍♀️ تم رفع الـعـضو  متوحد في الجروب \n'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 🧚🏻‍♀️ الـعـضو   ↚ ['..data.first_name_..'](t.me/'..(data.username_ or 'textchuser')..')'
status  = '\n 🧚🏻‍♀️ تم تنزيل الـعـضو  متوحد في الجروب\n'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 🧚🏻‍♀️ العضــو  ↚ ['..data.first_name_..'](t.me/'..(data.username_ or 'textchuser')..')'
...
-----------------------------------------------------
if text == 'مسح البكاراس' and Mod(msg) then
database:del(bot_id..'Zahf:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, ' 🧚🏻‍♀️ تم تنزيل جميع االبكاراس')
end
if text == ("تاك للبكاراس") and Mod(msg) then
...
database:del(bot_id..'Zahf:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, ' 🧚🏻‍♀️ تم تنزيل جميع القلوب ')
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 🧚🏻‍♀️ الـعـضو   ↚ ['..data.first_name_..'](t.me/'..(data.username_ or 'UU_SD1')..')'
local statuss = '\n 🧚🏻‍♀️ تم رفع الـعـضو  علي زبك بنجاح\n 🧚🏻‍♀️ تفضل ابدا نيك'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
database:sadd(bot_id..'Zahf:User'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 🧚🏻‍♀️ الـعـضو  ← ['..data.first_name_..'](t.me/'..(data.username_ or 's_o_op')..')'
...
database:del(bot_id..'Girl:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, ' 🧚🏻‍♀️ تم مسح كل النسوان بالجروب')
end
if text == ("تاك للنسوان") and Mod(msg) then
local list = database:smembers(bot_id..'Girl:User'..msg.chat_id_)
t = "\n 🧚🏻‍♀️ قائمة نسوان الجروب \n≪━━━━━━𝑩𝑨𝑲𝑨𝑹━━━━━━≫\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 🧚🏻‍♀️ الـعـضو  ← ['..data.first_name_..'](t.me/'..(data.username_ or 's_o_op')..')'
local  statuss  = '\n 🧚🏻‍♀️ تم رفع مره في الجروب\n 🧚🏻‍♀️ ها صرتي من نسواني تعي ندخل'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 🧚🏻‍♀️ الـعـضو  ← ['..data.first_name_..'](t.me/'..(data.username_ or 's_o_op')..')'
status  = '\n 🧚🏻‍♀️ تم تنزيل مره من الجروب\n 🧚🏻‍♀️ بتاعي غضبان عليكي ليوم الدين'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
database:del(bot_id..'Mode:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, ' 🧚🏻‍♀️ تم مسح جميع المتزوجين')
end
if text == ("تاك للمتزوجين") and Mod(msg) then
local list = database:smembers(bot_id..'Mode:User'..msg.chat_id_)
t = "\n 🧚🏻‍♀️ قائمه ازواج الجروب \n≪━━━━━━𝑩𝑨𝑲𝑨𝑹━━━━━━≫\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 🧚🏻‍♀️ العضــو ← ['..data.first_name_..'](t.me/'..(data.username_ or 'DEVBESSO')..')'
local  statuss  = '\n 🧚🏻‍♀️ تم زواجكم بنجاح في الجروب \n 🧚🏻‍♀️ الطلاق امتي عشان ابقي موجود '
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
database:srem(bot_id..'Mode:User'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 🧚🏻‍♀️ العضــو ← ['..data.first_name_..'](t.me/'..(data.username_ or 's_o_op')..')'
status  = '\n 🧚🏻‍♀️ تم طلاقكم بنجاح في الجروب\n 🧚🏻‍♀️ اوجعو تاني ونبي'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
if database:get(bot_id..'Lock:Add:Bot'..msg.chat_id_) and not Constructor(msg) then
send(msg.chat_id_, msg.id_,' 🧚🏻‍♀️ تم تعطيل القتل') 
return false
end
function start_function(extra, result, success)
database:sadd(bot_id..'Zahf:User'..msg.chat_id_, result.sender_user_id_)
...
return send(msg.chat_id_, msg.id_,"🧚🏻‍♀️ تم وضع وقت التنظيف:( `"..GetDo.." `) ساعه")
end
...
usertext = '\n 🧚🏻‍♀️  الـعـضو   ↚ ['..result.title_..'](t.me/'..(username or 'textchuser')..')'
status  = '\n 🧚🏻‍♀️  تم تنزيله مشرف من الجروب بكل الصلاحيات'
texts = usertext..status
send(msg.chat_id_, msg.id_, texts)
https.request("https://api.telegram.org/bot"..token.."/promoteChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" ..result.id_.."&can_change_info=false&can_delete_messages=false&can_invite_users=false&can_restrict_members=false&can_pin_messages=false&can_promote_members=false")
else
...
if Constructor(msg) then  
database:set(bot_id.."pp_photo:status"..msg.chat_id_,true) 
send(msg.chat_id_, msg.id_," 🧚🏻‍♀️ تم تفعيل نسبه جمالك") 
return false  
end
end
...
if Constructor(msg) then  
database:del(bot_id.."pp_photo:status"..msg.chat_id_) 
send(msg.chat_id_, msg.id_," 🧚🏻‍♀️ تم تعطيل نسبه جمالك") 
return false end
end
if text == "الرابط" then 
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n 🧚🏻‍♀️ الـعـضو   ↚ ['..result.title_..'](t.me/'..(text1[3] or 'textchuser')..')'..'\n 🧚🏻‍♀️ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
send(msg.chat_id_,msg.id_,' 🧚🏻‍♀️ تم مسح {'..num..'}')  
...
send(msg.chat_id_, msg.id_,' 🧚🏻‍♀️ ارسل الكلمه تريد مسحها')
...
send(msg.chat_id_, msg.id_," 🧚🏻‍♀️ تم مسح الرد من ردود المتعدده")
...
send(msg.chat_id_, msg.id_," 🧚🏻‍♀️تم مسح ردود المتعدده")
end
------------------------------------------------------------------------
if text1 then 
...
send(msg.chat_id_, msg.id_,' 🧚🏻‍♀️ ارسل الكلمه التي تريد مسحها')
...
return send(msg.chat_id_, msg.id_," 🧚🏻‍♀️ارسل الان الكلمه لمسحها ")
end
if text then  
...
send(msg.chat_id_, msg.id_," 🧚🏻‍♀️تـم تـفعـيل ردود السورس") 
return false  
end
end
...
send(msg.chat_id_, msg.id_," 🧚🏻‍♀️ تـم تـعـطـيل ردود السورس") 
return false end
end
...
local my_ph = database:get(bot_id.."my_GHoeq2:status"..msg.chat_id_)
if not my_ph then
send(msg.chat_id_, msg.id_," 🧚🏻‍♀️معطله") 
return false  
end
...
local Name = '['..result.first_name_..'](tg://user?id='..result.id_..')'
Text = ' 🧚🏻‍♀️ هوا ابن القمر دا الي ضافك😹 ↚ '..Name
...
Text = '\n 🧚🏻‍♀️ بالتاكيد تم تعطيل امر اطردني مفيش خروج يولاد القمر 😹'
end
send(msg.chat_id_, msg.id_,Text) 
end
if text == "صورتي"  then
...
if not my_ph then
send(msg.chat_id_, msg.id_," 🧚🏻‍♀️اكتب تفعيل نسبه جمالي") 
return false  
end
local function getpro(extra, result, success)
if result.photos_[0] then
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, result.photos_[0].sizes_[1].photo_.persistent_id_," 🧚🏻‍♀️نسبه جمالك هيا ⇜ %"..result.total_count_.." يختي قمر يجدعان 🌚💕", msg.id_, msg.id_, "md")
else
send(msg.chat_id_, msg.id_,'لا تمتلك صوره في حسابك', 1, 'md')
  end end
tdcli_function ({ ID = "GetUserProfilePhotos", user_id_ = msg.sender_user_id_, offset_ = 0, limit_ = 1 }, getpro, nil)
...
send(msg.chat_id_, msg.id_," 🧚🏻‍♀️ تم تغير رد الـعـضو  الى  ↚ "..Teext)
end
...
if not Mod(msg) then
send(msg.chat_id_, msg.id_,' 🧚🏻‍♀️ هذا الامر خاص بي\n الادمن ، المطور الاساسي ، المدير ، مطور اساسي²\n ، المطور ، المدير عام ، الادمن العام ، المنشئ\n ارسل ❲اوامر الاعضاء❳لعرض اوامر الاعضاء')
return false
end
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
...
send(msg.chat_id_, msg.id_," 🧚🏻‍♀️تـم تـفعـيل مريم") 
return false  
end
end
...
send(msg.chat_id_, msg.id_," 🧚🏻‍♀️ تـم تـعـطـيل مريم") 
return false end
end
if text == "مريم" then
local my_ph = database:get(bot_id.."my_maryam:status"..msg.chat_id_)
if not my_ph then
send(msg.chat_id_, msg.id_," 🧚🏻‍♀️مريم  معطله") 
return false  
end
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
...
local Teext =[[
 ...
 🧚🏻‍♀️ اضف ترحيب
 🧚🏻‍♀️  مسح المحظورين ⇔ المكتومين
 🧚🏻‍♀️ منع + الكلمه
 🧚🏻‍♀️ الغاء منع + الكلمه
 🧚🏻‍♀️  مسح الكلمات الممنوعه
 🧚🏻‍♀️ المميزين عام
 🧚🏻‍♀️  ❲ + ❳ جميع ماسبق
 ≪━━━━━━𝑩𝑨𝑲𝑨𝑹━━━━━━≫
 🧚🏻‍♀️ ❲ المالك❳ ⇊
 ≪━━━━━━𝑩𝑨𝑲𝑨𝑹━━━━━━≫
 🧚🏻‍♀️ اضف صوره ⇔ وصف (للجروب)
 🧚🏻‍♀️ رفع منشئ ⇔ تنزيل منشئ
 🧚🏻‍♀️ تاج للاعضاء ⇔ للكل
 🧚🏻‍♀️ اضف رابط ⇔ مسح الرابط
 🧚🏻‍♀️ اضف ⇔  مسح  ❲ امر ❳
 🧚🏻‍♀️ الاوامر المضافه
 🧚🏻‍♀️  مسح الاوامر المضافه
 🧚🏻‍♀️ ضع اسم+الاسم ⇔ تحديث
...
local Teext =[[
 🧚🏻‍♀️مرحب بيك في اوامر الوضع واضف 🧚🏻‍♀️
≪━━━━━━𝑩𝑨𝑲𝑨𝑹━━━━━━≫ 
 🧚🏻‍♀️اوامر الوضع - اضف
≪━━━━━━𝑩𝑨𝑲𝑨𝑹━━━━━━≫
 🧚🏻‍♀️اضف / مسح ← رد
...
local Teext =[[
 🧚🏻‍♀️مرحب بيك في اوامر تنزيل ورفع 🧚🏻‍♀️
≪━━━━━━𝑩𝑨𝑲𝑨𝑹━━━━━━≫ 
 🧚🏻‍♀️اوامر تنزيل ورفع
≪━━━━━━𝑩𝑨𝑲𝑨𝑹━━━━━━≫ 
 🧚🏻‍♀️مميز
...
send(msg.chat_id_, msg.id_,' 🧚🏻‍♀️ تم مسح الامر')  
else
